import numpy
import cv2
opencv_haystack = cv2.imread(r'C:\Users\tiehu\Desktop\project\OpenCV\2.jpg')
# opencv_needle = cv2.imread('lena1.jpg')
opencv_needle = cv2.imread(r'C:\Users\tiehu\Desktop\project\OpenCV\4.jpg')
